...
export const api = {
  ...
  createSession: (data, token) => request("/v1/sessions", { method: "POST", token, body: JSON.stringify(data) }),
  ...
  releasePayment: (id, token) => request(`/v1/payments/${id}/release`, { method: "POST", token }),
